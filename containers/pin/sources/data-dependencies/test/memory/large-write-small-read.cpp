...
.balign 16;   mov    DWORD PTR [rdi], 1
.balign 16;   mov    cx, WORD PTR [rdi]
.balign 16;   mov    dx, WORD PTR [rdi+2]

.balign 16;   mov    DWORD PTR [rdi], 2
.balign 16;   mov    cx, WORD PTR [rdi]
.balign 16;   mov    dx, WORD PTR [rdi+2]
...
.balign 16;   mov    cx, WORD PTR [edi]
.balign 16;   mov    dx, WORD PTR [edi+2]
