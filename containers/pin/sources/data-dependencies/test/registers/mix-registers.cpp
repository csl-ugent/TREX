...
// CHECK:      Instructions: [[EXE_NAME]]+0x[[#FUNC_ADDR + mul(0, 16)]] <- [[EXE_NAME]]+0x[[#FUNC_ADDR + mul(3, 16)]]
// CHECK:      Register:
// CHECK-SAME: [[gax]]

// CHECK:      Instructions: [[EXE_NAME]]+0x[[#FUNC_ADDR + mul(0, 16)]] <- [[EXE_NAME]]+0x[[#FUNC_ADDR + mul(4, 16)]]
// CHECK:      Register:
// CHECK-SAME: [[gax]]
